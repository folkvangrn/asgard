...
const GET_ACTIVITIES_QUERY = 'http://vehicle-remedy.nixenos.ovh/api/v1/activities';
const GET_WORKERS_QUERY = 'http://vehicle-remedy.nixenos.ovh/api/v1/users/workers';
const GET_ACTIVITY_DICTIONARY = 'http://vehicle-remedy.nixenos.ovh/api/v1/activity-dictionary';
